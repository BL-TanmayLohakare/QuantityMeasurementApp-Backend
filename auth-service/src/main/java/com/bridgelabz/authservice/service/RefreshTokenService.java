...
import com.bridgelabz.authservice.repository.RefreshTokenRepository;
...
public class RefreshTokenService {
    @Value("${qma.app.jwtRefreshExpirationMs:604800000}")
    ...
    public RefreshToken createRefreshToken(String email) {
        ...
        // Remove existing token for user to maintain 1 token per user session
